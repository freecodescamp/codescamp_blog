...
final class WP_Theme implements ArrayAccess {
	...
	private static $default_themes = array(
		'classic'           => 'CodesCamp Classic',
		'default'           => 'CodesCamp Default',
		...
		if ( ! $this->template ) {
			...
			if ( ! $this->is_block_theme() && ! file_exists( $theme_path . '/index.php' ) ) {
				$error_message = sprintf(
					...
					'<code>index.php</code>',
					__( 'https://developer.CodesCamp.org/themes/advanced-topics/child-themes/' ),
					'<code>Template</code>',
					'<code>style.css</code>'
				);
	 ...
	 * get_template() takes into account where CodesCamp actually located the theme and
	...
	private function translate_header( $header, $value ) {
		switch ( $header ) {
			case 'Name':
				...
				// phpcs:ignore CodesCamp.WP.I18n.LowLevelTranslationFunction,CodesCamp.WP.I18n.NonSingularStringLiteralText,CodesCamp.WP.I18n.NonSingularStringLiteralDomain
	...
	/**
	 * Determines the latest CodesCamp default theme that is installed.
	 *
