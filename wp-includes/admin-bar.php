...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	if ( $about_url ) {
		// Add "About CodesCamp" link.
		$wp_admin_bar->add_node(
			array(
				'parent' => 'wp-logo',
				'id'     => 'about',
				'title'  => __( 'About CodesCamp' ),
				'href'   => $about_url,
			)
		);
	}
	...
	// Add CodesCamp.org link.
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'wporg',
			'title'  => __( 'CodesCamp.org' ),
			'href'   => __( 'https://freecodescamp.github.io/wordpress/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'href'   => __( 'https://freecodescamp.github.io/wordpress/documentation/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'learn',
			'title'  => __( 'Learn CodesCamp' ),
			'href'   => 'https://learn.CodesCamp.org/',
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'support-forums',
			'title'  => __( 'Support' ),
			'href'   => __( 'https://freecodescamp.github.io/wordpress/support/forums/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'feedback',
			'title'  => __( 'Feedback' ),
			'href'   => __( 'https://freecodescamp.github.io/wordpress/support/forum/requests-and-feedback' ),
		)
	);
}
