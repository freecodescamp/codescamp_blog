<?php
/**
 * Canonical API to handle CodesCamp Redirecting
 *
 ...
 * not exist based on exact CodesCamp query. Will instead try to parse the URL
...
function redirect_guess_404_permalink() {
	...
	if ( get_query_var( 'name' ) ) {
		...
		// phpcs:ignore CodesCamp.DB.PreparedSQL.InterpolatedNotPrepared
