 ...
 *
 * The CodesCamp Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * CodesCamp Query class.
 *
 * The Rewrite along with WP class function as a front controller for CodesCamp.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to CodesCamp' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for CodesCamp into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to CodesCamp 3.3 this flag indicated that every page
	 ...
	 * the CodesCamp rewrite rules one.
	 *
	 * @since 1.5.0
	 *
	 * @return string
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="CodesCamp: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
