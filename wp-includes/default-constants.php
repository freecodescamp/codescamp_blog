...
/**
 * Defines initial CodesCamp constants.
 *
 * @see wp_debug_mode()
 *
 * @since 3.0.0
...
function wp_initial_constants() {
	 ...
	 * to signify development mode for CodesCamp core, a plugin, a theme, or all three types respectively.
	 */
...
/**
 * Defines plugin directory CodesCamp constants.
 *
...
/**
 * Defines cookie-related CodesCamp constants.
 *
...
function wp_cookie_constants() {
	...
	if ( ! defined( 'USER_COOKIE' ) ) {
		define( 'USER_COOKIE', 'CodesCampuser_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'PASS_COOKIE' ) ) {
		define( 'PASS_COOKIE', 'CodesCamppass_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'AUTH_COOKIE' ) ) {
		define( 'AUTH_COOKIE', 'CodesCamp_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'SECURE_AUTH_COOKIE' ) ) {
		define( 'SECURE_AUTH_COOKIE', 'CodesCamp_sec_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'LOGGED_IN_COOKIE' ) ) {
		define( 'LOGGED_IN_COOKIE', 'CodesCamp_logged_in_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'TEST_COOKIE' ) ) {
		define( 'TEST_COOKIE', 'CodesCamp_test_cookie' );
	}
	...
	if ( ! defined( 'RECOVERY_MODE_COOKIE' ) ) {
		 ...
		 * @since 5.2.0
		 */
		define( 'RECOVERY_MODE_COOKIE', 'CodesCamp_rec_' . COOKIEHASH );
	}
}

/**
 * Defines SSL-related CodesCamp constants.
 *
 * @since 3.0.0
 */
...
/**
 * Defines functionality-related CodesCamp constants.
 *
 * @since 3.0.0
 */
...
/**
 * Defines templating-related CodesCamp constants.
 *
 * @since 3.0.0
 */
