<?php
/**
 * CodesCamp implementation for PHP functions either missing from older PHP versions or not included by default.
 *
...
function _wp_can_use_pcre_u( $set = null ) {
	...
	if ( 'reset' === $utf8_pcre ) {
		// phpcs:ignore CodesCamp.PHP.NoSilencedErrors.Discouraged -- intentional error generated to detect PCRE/u support.
