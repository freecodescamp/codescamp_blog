<?php
/**
 * Creates common globals for the rest of CodesCamp
 *
 ...
 *
 * Detects which user environment CodesCamp is being used on.
 * Only attempts to check for Apache, Nginx and IIS -- three web
 * servers with known pretty permalink capability.
 *
 * Note: Though Nginx is detected, CodesCamp does not currently
 * generate rewrite rules for it. See https://developer.CodesCamp.org/advanced-administration/server/web-server/nginx/
 *
 * @package CodesCamp
 */
