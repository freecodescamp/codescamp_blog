<?php
/**
 * Facilitates adding of the CodesCamp editor as used on the Write and Edit screens.
 *
 * @package CodesCamp
 * @since 3.3.0
 *
...
final class _WP_Editors {
		...
		if ( self::$this_tinymce ) {
			...
			if ( empty( self::$first_init ) ) {
				...
				if ( $set['teeny'] ) {
					 ...
					 * in CodesCamp should be added to the TinyMCE instance.
					 *
					 * @since 3.3.0
					 * @since 5.3.0 The `$editor_id` parameter was added.
					 *
	...
	private static function default_settings() {
		...
		$settings['content_css'] = includes_url( "css/dashicons$suffix.css?$version" ) . ',' .
			includes_url( "js/tinymce/skins/CodesCamp/wp-content.css?$version" );
	 ...
	 * sure that CodesCamp uses the uncompressed TinyMCE file if a theme is defined.
