 ...
 *
 * @link https://developer.CodesCamp.org/advanced-administration/CodesCamp/oembed/
...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://CodesCamp\.tv/.*#i'                 => array( 'https://CodesCamp.tv/oembed/', true ),
			...
			'#https?://videopress\.com/v/.*#'              => array( 'https://public-api.CodesCamp.com/oembed/?for=' . $host, true ),
		 ...
		 *
		 * Since CodesCamp 4.4, oEmbed discovery is enabled for all users and allows embedding of sanitized
		 ...
		 * | CodesCamp.tv | CodesCamp.tv                              | 2.9.0   |
