<?php
/**
 * CodesCamp environment setup class.
 *
 * @package CodesCamp
 * @since 2.0.0
 */
...
class WP {
	...
	/**
	 * Query variables for setting up the CodesCamp Query Loop.
	 *
	 * @since 2.0.0
	 * @var array
	 */
	...
	/**
	 * Parses the request to find the correct CodesCamp query.
	 *
	...
	public function parse_request( $extra_query_vars = '' ) {
		 ...
		 * @param WP           $wp               Current CodesCamp environment instance.
		 ...
		 * @since 2.1.0
		 *
		 * @param WP $wp Current CodesCamp environment instance (passed by reference).
		 */
	...
	/**
	 * Set up the CodesCamp Globals.
	 *
	 * The query_vars property will be extracted to the GLOBALS. So care should
	 * be taken when naming global variables that might interfere with the
	 * CodesCamp environment.
	 *
	 * @since 2.0.0
	 *
	 * @global WP_Query     $wp_query     CodesCamp Query object.
	...
	public function handle_404() {
		 ...
		 * @param WP_Query $wp_query CodesCamp Query object.
		 */
	...
	/**
	 * Sets up all of the variables required by the CodesCamp environment.
	 *
	...
	public function main( $query_args = '' ) {
		...
		/**
		 * Fires once the CodesCamp environment has been set up.
		 *
		 * @since 2.1.0
		 *
		 * @param WP $wp Current CodesCamp environment instance (passed by reference).
