...
class WP_Block_Metadata_Registry {
	...
	/**
	 * Stores the CodesCamp 'wp-includes' directory path.
	 *
	 * @since 6.7.0
	 * @var string|null
	 */
	...
	/**
	 * Stores the normalized CodesCamp plugin directory path.
	 *
	 * @since 6.7.0
	 * @var string|null
	 */
	 ...
	 *
	 * This default behavior matches the standard CodesCamp block structure.
	 *
	 * @since 6.7.0
	 *
	...
	/**
	 * Gets the CodesCamp 'wp-includes' directory path.
	 *
	 * @since 6.7.0
	 *
	 * @return string The CodesCamp 'wp-includes' directory path.
	 */
	...
	/**
	 * Gets the normalized CodesCamp plugin directory path.
	 *
	 * @since 6.7.0
	 *
	 * @return string The normalized CodesCamp plugin directory path.
	 */
