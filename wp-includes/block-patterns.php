...
/**
 * Register Core's official patterns from CodesCamp.org/patterns.
 *
 * @since 5.8.0
...
/**
 * Register `Featured` (category) patterns from CodesCamp.org/patterns.
 *
 * @since 5.9.0
...
function _register_theme_block_patterns() {
	...
	foreach ( $themes as $theme ) {
		...
		foreach ( $patterns as $file => $pattern_data ) {
			...
			// phpcs:ignore CodesCamp.WP.I18n.NonSingularStringLiteralText,CodesCamp.WP.I18n.NonSingularStringLiteralDomain,CodesCamp.WP.I18n.LowLevelTranslationFunction
