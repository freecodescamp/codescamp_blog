...
class WP_Dependencies {
	 ...
	 *                                 to the CodesCamp root directory. If source is set to false,
	 ...
	 *                                 equal to current installed CodesCamp version.
	...
	public function get_etag( $load ) {
		 ...
		 * load the full CodesCamp environment, it is not possible to use the salted
		 * wp_hash() function.
		 */
		return 'W/"' . md5( $etag ) . '"';
	}
