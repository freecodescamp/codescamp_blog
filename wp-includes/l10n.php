...
function get_locale() {
	...
	/**
	 * Filters the locale ID of the CodesCamp installation.
	 *
	 * @since 1.5.0
	 *
 ...
 *
 * Loads the .mo file in WP_LANG_DIR constant path from CodesCamp root.
...
function load_script_textdomain( $handle, $domain = 'default', $path = '' ) {
	...
	if (
		 ...
		 * See https://core.trac.CodesCamp.org/ticket/60891 and https://core.trac.CodesCamp.org/ticket/62016.
		 */
