...
/**
 * Requires the template file with CodesCamp environment.
 *
 * The globals are set up for the template file to ensure that the CodesCamp
...
function load_template( $_template_file, $load_once = true, $args = array() ) {
	...
	if ( is_array( $wp_query->query_vars ) ) {
		 ...
		 */
		// phpcs:ignore CodesCamp.PHP.DontExtract.extract_extract
