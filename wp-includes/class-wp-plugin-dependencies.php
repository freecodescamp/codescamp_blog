<?php
/**
 * CodesCamp Plugin Administration API: WP_Plugin_Dependencies class
 *
 * @package CodesCamp
...
class WP_Plugin_Dependencies {
	...
	protected static function sanitize_dependency_slugs( $slugs ) {
		...
		foreach ( $slugs as $slug ) {
			...
			// Match to CodesCamp.org slug format.
	...
	/**
	 * Retrieves and stores dependency plugin data from the CodesCamp.org Plugin API.
	 *
	 * @since 6.5.0
	 *
