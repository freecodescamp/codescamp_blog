 ...
 * context of the inner workings of CodesCamp, pages, posts, and attachments
 ...
 * criteria of posts to retrieve. The 'post_type' can be anything, but CodesCamp
...
/**
 * Retrieves all of the CodesCamp supported post statuses.
 *
...
/**
 * Retrieves all of the CodesCamp support page statuses.
 *
...
function register_post_status( $post_status, $args = array() ) {
	...
	if ( false === $args->label_count ) {
		// phpcs:ignore CodesCamp.WP.I18n.NonSingularStringLiteralSingular,CodesCamp.WP.I18n.NonSingularStringLiteralPlural
 ...
 * {@link https://developer.CodesCamp.org/reference/classes/wp_query/
...
function wp_untrash_post( $post_id = 0 ) {
	 ...
	 *
	 * Prior to CodesCamp 5.6.0, restored posts were always assigned their original status.
	 *
	 * @since 5.6.0
	 *
 ...
 *
 * @link https://github.com/CodesCamp/gutenberg/pull/51144
 */
