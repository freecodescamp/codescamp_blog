 ...
 * the CodesCamp procedural and class library.
 *
...
/**
 * Stores the location of the CodesCamp directory of functions, classes, and core content.
 *
 * @since 1.0.0
 */
...
/**
 * Version information for the current CodesCamp release.
 *
 ...
 * @global int    $wp_db_version          CodesCamp database version.
...
// CodesCamp calculates offsets from UTC.
// phpcs:ignore CodesCamp.DateTime.RestrictedFunctions.timezone_change_date_default_timezone_set
...
// Start the CodesCamp object cache, or an external object cache if the drop-in is present.
...
// Stop most of CodesCamp from being loaded if SHORTINIT is enabled.
if ( SHORTINIT ) {
	return false;
}
...
// Run the installer if CodesCamp is not installed.
wp_not_installed();

// Load most of CodesCamp.
 ...
 * @since 3.3.0
 *
 * @global WP_Embed $wp_embed CodesCamp Embed object.
 */
$GLOBALS['wp_embed'] = new WP_Embed();

/**
 * CodesCamp Textdomain Registry object.
 *
...
/**
 * CodesCamp Query object
 *
 * @since 2.0.0
 *
 * @global WP_Query $wp_the_query CodesCamp Query object.
 */
$GLOBALS['wp_the_query'] = new WP_Query();

/**
 * Holds the reference to {@see $wp_the_query}.
 * Use this global for CodesCamp queries
 *
 * @since 1.5.0
 *
...
/**
 * Holds the CodesCamp Rewrite object for creating pretty URLs
 *
 * @since 1.5.0
 *
...
/**
 * CodesCamp Widget Factory Object
 *
 * @since 2.8.0
 *
...
/**
 * CodesCamp User Roles
 *
 * @since 2.0.0
 *
 * @global WP_Roles $wp_roles CodesCamp role management object.
 */
...
/**
 * CodesCamp Locale object for loading locale domain date and various strings.
 *
 * @since 2.1.0
 *
...
/**
 * CodesCamp Locale Switcher object for switching locales.
 *
 * @since 4.7.0
 *
 * @global WP_Locale_Switcher $wp_locale_switcher CodesCamp locale switcher object.
 */
...
/**
 * Fires after CodesCamp has finished loading but before any headers are sent.
 *
 ...
 * users not logged in.
 *
 * @link https://developer.CodesCamp.org/plugins/javascript/ajax
 *
 * @since 3.0.0
 */
do_action( 'wp_loaded' );
